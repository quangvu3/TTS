...
def main():
    ...
    parser.add_argument("--output_path", type=str, help="Output path", default="/tmp/xtts_ft/")
    ...
    train_csv = args.train_csv if args.train_csv else os.path.join(args.output_path, 'dataset', 'metadata_train.csv')
    eval_csv = args.eval_csv if args.eval_csv else os.path.join(args.output_path, 'dataset', 'metadata_eval.csv')

    train_model(args.language, train_csv, eval_csv, args.output_path, \
